(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('tslib'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('ngx-logger', ['exports', '@angular/core', '@angular/common/http', 'tslib', '@angular/common', 'rxjs'], factory) :
    (factory((global['ngx-logger'] = {}),global.ng.core,global.ng.common.http,global.tslib,global.ng.common,global.rxjs));
}(this, (function (exports,core,http,tslib,common,rxjs) { 'use strict';
    ...
    /** @nocollapse */
    NGXLoggerHttpService.ctorParameters = function () {
        return [
    ...
    var NGXLogger = (function () {
        ...
        NGXLogger.prototype._logIE = function (level, metaString, message, additional) {
            ...
            switch (level) {
                case NgxLoggerLevel.WARN:
                    console.warn.apply(console, tslib.__spread([metaString + " ", message], additional));
                    break;
                case NgxLoggerLevel.ERROR:
                    console.error.apply(console, tslib.__spread([metaString + " ", message], additional));
                    break;
                case NgxLoggerLevel.INFO:
                    console.info.apply(console, tslib.__spread([metaString + " ", message], additional));
                    break;
                default:
                    console.log.apply(console, tslib.__spread([metaString + " ", message], additional));
            }
        };
        /**
         * @param {?} level
        ...
        NGXLogger.prototype._log = function (level, message, additional, logOnServer) {
            ...
            console.log.apply(console, tslib.__spread(["%c" + metaString, "color:" + color, message], (additional || [])));
        };
        return NGXLogger;
    }());
    ...
    /** @nocollapse */
    NGXLogger.ctorParameters = function () {
        return [
    ...
    /** @nocollapse */
    CustomNGXLoggerService.ctorParameters = function () {
        return [
            { type: NGXLoggerHttpService, },
            { type: undefined, decorators: [{ type: core.Inject, args: [core.PLATFORM_ID,] },] },
        ];
